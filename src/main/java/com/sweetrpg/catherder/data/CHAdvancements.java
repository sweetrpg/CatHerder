...
public class CHAdvancements extends ForgeAdvancementProvider {

    public CHAdvancements(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
        super(output, lookupProvider, existingFileHelper, List.of(new CHAdvancementProvider()));
    }
}
