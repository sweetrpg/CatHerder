...
import com.sweetrpg.catherder.common.block.FoodBowlBlock;
...
public class CatBlocks {
    ...
    public static final DeferredRegister<Item> ITEMS = CatItems.ITEMS;

    public static final RegistryObject<CatBedBlock> CAT_BED = registerWithItem("cat_bed", CatBedBlock::new, (prop) -> prop.tab(CatItemGroups.CAT_BED));
