...
public class WildCatnipBlock extends FlowerBlock /* implements BonemealableBlock */ {
    protected static final VoxelShape SHAPE = Block.box(2.0D, 0.0D, 2.0D, 14.0D, 13.0D, 14.0D);
    private final boolean renderOffset;

    public WildCatnipBlock(MobEffect suspiciousStewEffect, int effectDuration, Properties properties) {
        super(suspiciousStewEffect, effectDuration, properties);
        this.renderOffset = true;
    }

    public WildCatnipBlock(MobEffect suspiciousStewEffect, int effectDuration, Properties properties, boolean hasOffset) {
        super(suspiciousStewEffect, effectDuration, properties);
