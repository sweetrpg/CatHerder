...
//    public static final String TRANSLATION_KEY_GUI_TEXTURE_INDEX = "catgui.textureindex";
    ...
    public static final String TRANSLATION_KEY_CATTREE_COLOR_WHITE = "cattree.color.minecraft.white_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_BLACK = "cattree.color.minecraft.black_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_GREY = "cattree.color.minecraft.gray_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_LIGHT_GREY = "cattree.color.minecraft.light_gray_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_PURPLE = "cattree.color.minecraft.purple_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_PINK = "cattree.color.minecraft.pink_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_BROWN = "cattree.color.minecraft.brown_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_ORANGE = "cattree.color.minecraft.orange_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_YELLOW = "cattree.color.minecraft.yellow_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_GREEN = "cattree.color.minecraft.green_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_LIME = "cattree.color.minecraft.lime_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_BLUE = "cattree.color.minecraft.blue_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_LIGHT_BLUE = "cattree.color.minecraft.light_blue_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_MAGENTA = "cattree.color.minecraft.magenta_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_RED = "cattree.color.minecraft.red_wool";
    public static final String TRANSLATION_KEY_CATTREE_COLOR_CYAN = "cattree.color.minecraft.cyan_wool";
    ...
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_OAK = "petdoor.structure.minecraft.oak_planks";
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_DARK_OAK = "petdoor.structure.minecraft.dark_oak_planks";
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_BIRCH = "petdoor.structure.minecraft.birch_planks";
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_SPRUCE = "petdoor.structure.minecraft.spruce_planks";
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_ACACIA = "petdoor.structure.minecraft.acacia_planks";
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_JUNGLE = "petdoor.structure.minecraft.jungle_planks";
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_CRIMSON = "petdoor.structure.minecraft.crimson_stem";
    public static final String TRANSLATION_KEY_PETDOOR_STRUCTURE_WARPED = "petdoor.structure.minecraft.warped_stem";
