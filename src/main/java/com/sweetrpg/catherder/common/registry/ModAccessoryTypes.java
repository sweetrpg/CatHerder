...
public class ModAccessoryTypes {
    ...
    public static final DeferredRegister<AccessoryType> ACCESSORY_TYPES = DeferredRegister.create(CatHerderAPI.RegistryKeys.ACCESSORY_TYPE_REGISTRY, CatHerderAPI.MOD_ID);
