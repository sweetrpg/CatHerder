...
//            dropsSelf(CatBlocks.CAT_BATH);
            dropCatbed(CatBlocks.CAT_BED);
            dropsSelf(CatBlocks.FOOD_BOWL); // Drop with the name of the cat bowl
            dropsSelf(CatBlocks.LITTER_BOX);
        }
        ...
        protected Iterable<Block> getKnownBlocks() {
            return CatBlocks.BLOCKS.getEntries().stream().map(Supplier::get).collect(Collectors.toList());
        }
    }
    ...
    private static class Entities extends EntityLoot {
        ...
        @Override
        protected void addTables() {
            this.registerNoLoot(CatEntityTypes.CAT);
        }
        ...
        protected Iterable<EntityType<?>> getKnownEntities() {
            return CatEntityTypes.ENTITIES.getEntries().stream().map(Supplier::get).collect(Collectors.toList());
        }
    }
}
