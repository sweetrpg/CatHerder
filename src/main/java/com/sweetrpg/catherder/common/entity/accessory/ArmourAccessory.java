...
//            if (this.of(CatAccessories.IRON_HELMET)) {
//                armourStack = new ItemStack(Items.IRON_HELMET);
//            } else if (this.of(CatAccessories.DIAMOND_HELMET)) {
//                armourStack = new ItemStack(Items.DIAMOND_HELMET);
//            } else if (this.of(CatAccessories.GOLDEN_HELMET)) {
//                armourStack = new ItemStack(Items.GOLDEN_HELMET);
//            } else if (this.of(CatAccessories.CHAINMAIL_HELMET)) {
//                armourStack = new ItemStack(Items.CHAINMAIL_HELMET);
//            } else if (this.of(CatAccessories.TURTLE_HELMET)) {
//                armourStack = new ItemStack(Items.TURTLE_HELMET);
//            } else if (this.of(CatAccessories.NETHERITE_HELMET)) {
...
//            }
    ...
    public class Instance extends AccessoryInstance implements ICatAlteration {
        ...
        @Override
        public void remove(AbstractCatEntity catIn) {
            EquipmentSlot slotType = null;
