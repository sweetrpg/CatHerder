...
public class BowTieModel extends ListModel<CatEntity> {
...
//        this.leftChest.setPos(0.0F, 14.0F, 2.0F);
    ...
    @Override
    public void setupAnim(CatEntity catIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
