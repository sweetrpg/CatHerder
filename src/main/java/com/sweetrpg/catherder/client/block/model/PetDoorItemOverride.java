...
@OnlyIn(Dist.CLIENT)
public class PetDoorItemOverride extends ItemOverrides {
    ...
    public BakedModel resolve(BakedModel modelOriginal, ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity livingEntity, int p_173469_) {
        if (modelOriginal instanceof PetDoorModel petDoorModel) {
            IStructureMaterial structureMaterial = PetDoorUtil.getStructureMaterial(stack);
            return petDoorModel.getModelVariant(structureMaterial, Direction.NORTH);
        }
