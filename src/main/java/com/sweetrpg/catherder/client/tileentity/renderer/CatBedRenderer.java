...
//
//public class CattreeRenderer implements BlockEntityRenderer<CattreeTileEntity> {
//
//    public CattreeRenderer(BlockEntityRendererProvider.Context ctx) {}
//
//    @Override
//    public void render(CattreeTileEntity tileEntityIn, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
...
//    }
//
//    public boolean isLookingAtBed(CattreeTileEntity tileEntityIn) {
