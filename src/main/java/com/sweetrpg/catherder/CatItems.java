...
//    public static final RegistryObject<Item> THROW_STICK_WET = registerThrowStickWet("throw_stick_wet");
    ...
    public static final RegistryObject<Item> BREEDING_TREAT = register("breeding_bone");
    ...
    public static final RegistryObject<AccessoryItem> RADIO_COLLAR = registerAccessory("radio_collar", CatAccessories.RADIO_BAND);
    public static final RegistryObject<DyeableAccessoryItem> WOOL_COLLAR = registerAccessoryDyed("wool_collar", CatAccessories.DYEABLE_COLLAR);
    public static final RegistryObject<AccessoryItem> CREATIVE_COLLAR = registerAccessory("creative_collar", CatAccessories.GOLDEN_COLLAR);
    public static final RegistryObject<AccessoryItem> SPOTTED_COLLAR = registerAccessory("spotted_collar", CatAccessories.SPOTTED_COLLAR);
    public static final RegistryObject<AccessoryItem> MULTICOLOURED_COLLAR = registerAccessory("multicoloured_collar", CatAccessories.MULTICOLORED_COLLAR);
...
//    public static final RegistryObject<Item> WHISTLE = registerWith("whistle", WhistleItem::new, 1);
    ...
    public static final RegistryObject<AccessoryItem> CAPE = registerAccessory("cape", CatAccessories.CAPE);
//    public static final RegistryObject<DyeableAccessoryItem> CAPE_COLOURED = registerAccessoryDyed("cape_coloured", CatAccessories.DYEABLE_CAPE);
    public static final RegistryObject<AccessoryItem> SUNGLASSES = registerAccessory("sunglasses", CatAccessories.SUNGLASSES);
...
//    public static final RegistryObject<Item> TINY_BONE = registerSizeBone("tiny_bone", BundleOfCatnipItem.Type.TINY);
//    public static final RegistryObject<Item> BIG_BONE = registerSizeBone("big_bone", BundleOfCatnipItem.Type.BIG);
...
//    public static final RegistryObject<Item> LITTER_BOX = register("litter_box", LitterBoxItem::new);
    ...
    private static Item.Properties createInitialProp() {
        return new Item.Properties().tab(CatItemGroups.GENERAL);
    }
...
//    }
    ...
    private static RegistryObject<Item> registerSizeBone(final String name, final BundleOfCatnipItem.Type typeIn) {
    ...
    public static void registerItemColours(final ColorHandlerEvent.Item event) {
        ...
        Util.acceptOrElse(CatItems.WOOL_COLLAR, (item) -> {
