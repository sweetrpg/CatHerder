...
public class KittyEntityTypes {
    ...
    public static final RegistryObject<EntityType<kittytalents.common.entity.CatEntity>> CAT = register("cat", CatEntity::new, MobCategory.CREATURE, (b) -> b
            .sized(0.6F, 0.85F)
            .setUpdateInterval(3)
            .setTrackingRange(16)
            .setShouldReceiveVelocityUpdates(true));

    public static final RegistryObject<EntityType<KittyBeamEntity>> DOG_BEAM = register("dog_beam", KittyBeamEntity::new, MobCategory.MISC, (b) -> b
            .sized(0.25F, 0.25F)
            .setUpdateInterval(4)
            .setTrackingRange(10)
            .setShouldReceiveVelocityUpdates(true)
            .setCustomClientFactory(KittyBeamEntity::new)
            .noSummon());
    ...
    public static void addEntityAttributes(EntityAttributeCreationEvent e) {
        e.put(CAT.get(),
                 ...
                 .add(KittyAttributes.JUMP_POWER.get(), 0.42D)
                 .add(KittyAttributes.CRIT_CHANCE.get(), 0.01D)
                 .add(KittyAttributes.CRIT_BONUS.get(), 1D)
                 .build()
         );
     }
}
