...
public class CatRescueModel extends ListModel<kittytalents.common.entity.CatEntity>{
...
//        this.rescueBox.xRot = (float) (Math.PI / 2);
    ...
    @Override
    public void setupAnim(kittytalents.common.entity.CatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
