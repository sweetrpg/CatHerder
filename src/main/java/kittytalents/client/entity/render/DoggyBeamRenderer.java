...
public class KittyBeamRenderer<T extends Entity> extends EntityRenderer<T> {

    private final net.minecraft.client.renderer.entity.ItemRenderer itemRenderer;
    private final float scale;
    private final boolean fullBright;

    public KittyBeamRenderer(EntityRendererProvider.Context ctx, float p_i226035_3_, boolean p_i226035_4_) {
        super(ctx);
    ...
    public KittyBeamRenderer(EntityRendererProvider.Context ctx) {
        this(ctx, 1.0F, false);
    }
