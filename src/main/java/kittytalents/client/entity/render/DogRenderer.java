...
public class DogRenderer extends MobRenderer<kittytalents.common.entity.CatEntity, kittytalents.client.entity.model.CatModel<kittytalents.common.entity.CatEntity>> {
...
//        this.addLayer(new DogAccessoryLayer(this, ctx));
    ...
    private Component getNameUnknown(kittytalents.common.entity.CatEntity dogIn) {
        return new TranslatableComponent(dogIn.getOwnerUUID() != null ? "entity.kittytalents.cat.unknown_owner" : "entity.kittytalents.cat.untamed");
    }

    @Override
    public ResourceLocation getTextureLocation(kittytalents.common.entity.CatEntity dogIn) {
        return kittytalents.client.CatTextureManager.INSTANCE.getTexture(dogIn);
    }

    @Override
    protected void scale(kittytalents.common.entity.CatEntity dogIn, PoseStack matrixStackIn, float partialTickTime) {
