package kittytalents.common.config;
...
public class ConfigHandler {
    ...
    public static void init(IEventBus modEventBus) {
        ...
        KittyTalents2.LOGGER.debug("Register configs");
    ...
    public static void initTalentConfig() {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.SERVER, CONFIG_TALENT_SPEC, "kittytalents-talents.toml");
    }
    ...
    public static class ClientConfig {
        ...
        public ClientConfig(ForgeConfigSpec.Builder builder) {
            ...
            DIRE_PARTICLES = builder
                    ...
                    .translation("kittytalents.config.client.enable_dire_particles")
            ...
            RENDER_CHEST = builder
                    ...
                    .translation("kittytalents.config.client.render_chest")
    ...
    public static class ServerConfig {
        ...
        public ServerConfig(ForgeConfigSpec.Builder builder) {
            ...
            DISABLE_HUNGER = builder
                    ...
                    .translation("kittytalents.config.cat.disable_hunger")
            ...
            STARTING_ITEMS = builder
                    ...
                    .translation("kittytalents.config.enable_starting_items")
            ...
            DOG_GENDER = builder
                    ...
                    .translation("kittytalents.config.enable_gender")
            ...
            PUPS_GET_PARENT_LEVELS = builder
                    ...
                    .translation("kittytalents.config.enable_pup_get_parent_levels")
            ...
            TIME_TO_MATURE = builder
                    ...
                    .translation("kittytalents.config.cat.time_to_mature")
            ...
            DOG_WHINE_WHEN_HUNGER_LOW = builder
                    ...
                    .translation("kittytalents.config.whine_when_hungry")
            ...
            EAT_FOOD_ON_FLOOR = builder
                    ...
                    .translation("kittytalents.config.eat_food_on_floor")
    ...
    public static class TalentConfig {
        ...
        public TalentConfig(ForgeConfigSpec.Builder builder) {
            ...
            KittyTalentsAPI.TALENTS.forEach((loc) ->
