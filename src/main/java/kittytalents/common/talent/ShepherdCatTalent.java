...
//        if (!catIn.hasData(SHEPHERD_AI)) {
//            EntityAIShepherdDog shepherdAI = new EntityAIShepherdDog(catIn, 1.0D, 8F, entity -> !(entity instanceof TamableAnimal));
//            catIn.goalSelector.addGoal(7, shepherdAI);
//            catIn.setData(SHEPHERD_AI, shepherdAI);
//        }
//    }
//
...
//
//        public EntityAIShepherdDog(kittytalents.api.inferface.AbstractCatEntity catIn, double speedIn, float range, @Nullable Predicate<Animal> targetSelector) {
//            this.cat = catIn;
//            this.world = catIn.level;
//            this.dogPathfinder = catIn.getNavigation();
...
//                return false;
//            } else if (this.cat.getCatLevel(KittyTalents.SHEPHERD_DOG) <= 0) {
//                return false;
//            } else {
...
//
//
//                        this.MAX_FOLLOW = kittytalents.common.talent.ShepherdCatTalent.getMaxFollowers(this.cat.getCatLevel(KittyTalents.SHEPHERD_DOG));
...
//                        this.cat.playSound(SoundEvents.CAT_AMBIENT, this.cat.getSoundVolume() + 1.0F, (this.cat.getRandom().nextFloat() - this.cat.getRandom().nextFloat()) * 0.1F + 0.9F);
//                    }
//
