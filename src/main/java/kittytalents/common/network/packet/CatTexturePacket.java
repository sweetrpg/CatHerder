...
import kittytalents.common.network.packet.data.CatTextureData;
...
public class CatTexturePacket extends CatPacket<CatTextureData> {
    ...
    @Override
    public void handleDog(kittytalents.common.entity.CatEntity catIn, CatTextureData data, Supplier<Context> ctx) {
