...
import kittytalents.common.network.packet.data.CatObeyData;
...
public class CatObeyPacket extends CatPacket<CatObeyData> {
    ...
    @Override
    public void handleDog(kittytalents.common.entity.CatEntity catIn, CatObeyData data, Supplier<Context> ctx) {
