...
import kittytalents.common.network.packet.data.DogTextureData;
...
public class DogTexturePacket extends DogPacket<DogTextureData> {
    ...
    @Override
    public void handleDog(kittytalents.common.entity.CatEntity dogIn, DogTextureData data, Supplier<Context> ctx) {
