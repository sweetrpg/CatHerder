...
import kittytalents.common.network.packet.data.CatModeData;
...
public class CatModePacket extends CatPacket<CatModeData> {
    ...
    @Override
    public void handleDog(kittytalents.common.entity.CatEntity catIn, CatModeData data, Supplier<Context> ctx) {
