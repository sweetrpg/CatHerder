...
//    public static final ResourceLocation ENTITY_WOLF_ANGRY = Util.getResource(Constants.VANILLA_ID, "textures/entity/wolf/wolf_angry.png");
    ...
    public static final ResourceLocation COLLAR_SPOTTED = getEntity("cat", "kitty_collar_1");
    public static final ResourceLocation COLLAR_MULTICOLORED = getEntity("cat", "kitty_collar_2");
    public static final ResourceLocation CLOTHING_LEATHER_JACKET = getEntity("cat", "kitty_leather_jacket");
    public static final ResourceLocation GUARD_SUIT = getEntity("cat", "kitty_guard_suit");
    public static final ResourceLocation GLASSES_SUNGLASSES = getEntity("cat", "kitty_sunglasses");
    public static final ResourceLocation BOW_TIE = getEntity("cat", "kitty_bowtie");
    public static final ResourceLocation CAPE = getEntity("cat", "kitty_cape");
    public static final ResourceLocation DYEABLE_CAPE = getEntity("cat", "kitty_cape1");
    public static final ResourceLocation RADIO_BAND = getEntity("cat", "kitty_radio_collar");
    public static final ResourceLocation TALENT_RESCUE = getEntity("cat/talents", "rescue");
    public static final ResourceLocation TALENT_CHEST = getEntity("cat", "kitty_chest");
