...
public class KittyTalentsAdvancements implements Consumer<Consumer<Advancement>> {

    @Override
    public void accept(Consumer<Advancement> register) {
        Advancement advancement = Advancement.Builder.advancement().display(KittyItems.TRAINING_TREAT.get(), new TranslatableComponent("advancements.cat.root.title"), new TranslatableComponent("advancements.cat.root.description"), new ResourceLocation("textures/gui/advancements/backgrounds/stone.png"), FrameType.TASK, false, false, false).addCriterion("crafting_table", InventoryChangeTrigger.TriggerInstance.hasItems(Blocks.CRAFTING_TABLE)).save(register, Util.getResourcePath("cat/find_dog"));
        ...
        Advancement advancement2 = Advancement.Builder.advancement().parent(advancement1).display(KittyItems.CAPE.get(), new TranslatableComponent("advancements.cat.upgrade_tools.title"), new TranslatableComponent("advancements.cat.upgrade_tools.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("stone_pickaxe", InventoryChangeTrigger.TriggerInstance.hasItems(Items.STONE_PICKAXE)).save(register, Util.getResourcePath("cat/accessorise"));
        Advancement advancement3 = Advancement.Builder.advancement().parent(advancement2).display(KittyItems.RADIO_COLLAR.get(), new TranslatableComponent("advancements.cat.smelt_iron.title"), new TranslatableComponent("advancements.cat.smelt_iron.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("iron", InventoryChangeTrigger.TriggerInstance.hasItems(Items.IRON_INGOT)).save(register, Util.getResourcePath("cat/radio_collar"));
    }
    ...
    public static class Builder {
        ...
        public static KittyTalentsAdvancements.Builder builder() {
           return new KittyTalentsAdvancements.Builder();
        }

        public KittyTalentsAdvancements.Builder withParent(Advancement parentIn) {
           this.parent = parentIn;
           return this;
        }

        public KittyTalentsAdvancements.Builder withParentId(ResourceLocation parentIdIn) {
           this.parentId = parentIdIn;
           return this;
        }

        public KittyTalentsAdvancements.Builder withDisplay(ItemStack stack, Component title, Component description, @Nullable ResourceLocation background, FrameType frame, boolean showToast, boolean announceToChat, boolean hidden) {
           return this.withDisplay(new DisplayInfo(stack, title, description, background, frame, showToast, announceToChat, hidden));
        }

        public KittyTalentsAdvancements.Builder withDisplay(ItemLike itemIn, Component title, Component description, @Nullable ResourceLocation background, FrameType frame, boolean showToast, boolean announceToChat, boolean hidden) {
        ...
        public KittyTalentsAdvancements.Builder withDisplay(DisplayInfo displayIn) {
           this.display = displayIn;
           return this;
        }

        public KittyTalentsAdvancements.Builder withRewards(AdvancementRewards.Builder rewardsBuilder) {
           return this.withRewards(rewardsBuilder.build());
        }

        public KittyTalentsAdvancements.Builder withRewards(AdvancementRewards rewards) {
         ...
         */
        public KittyTalentsAdvancements.Builder withCriterion(String key, CriterionTriggerInstance criterionIn) {
         ...
         * Adds a criterion to the list of criteria
         */
        public KittyTalentsAdvancements.Builder withCriterion(String key, Criterion criterionIn) {
        ...
        public KittyTalentsAdvancements.Builder withRequirementsStrategy(RequirementsStrategy strategy) {
