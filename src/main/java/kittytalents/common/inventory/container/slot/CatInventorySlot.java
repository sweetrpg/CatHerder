package kittytalents.common.inventory.container.slot;
...
public class CatInventorySlot extends SlotItemHandler {
    ...
    public CatInventorySlot(kittytalents.common.entity.CatEntity catIn, Player playerIn, IItemHandler itemHandler, int overallColumn, int row, int col, int index, int xPosition, int yPosition) {
...
//    }
    ...
    public kittytalents.common.entity.CatEntity getDog() {
        return this.cat;
    }
