...
public class FoodBowlContainer extends AbstractContainerMenu {
    ...
    public FoodBowlContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(KittyContainerTypes.FOOD_BOWL.get(), windowId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(this.tileEntity.getLevel(), this.tileEntity.getBlockPos()), player, KittyBlocks.FOOD_BOWL.get());
    }
