...
public class PackPuppyContainer extends AbstractContainerMenu {
    ...
    public PackPuppyContainer(int windowId, Inventory playerInventory, kittytalents.api.inferface.AbstractCatEntity dogIn) {
        super(KittyContainerTypes.PACK_PUPPY.get(), windowId);
        this.cat = dogIn;
        this.level = Mth.clamp(dogIn.getDogLevel(KittyTalents.PACK_PUPPY), 0, 5);
