...
public class DogLocationData implements IDogData {
    ...
    public void update(kittytalents.common.entity.CatEntity dogIn) {
        ...
        this.hasRadarCollar = dogIn.getAccessory(KittyAccessories.RADIO_BAND.get()).isPresent();
    ...
    public static DogLocationData from(DogLocationStorage storageIn, kittytalents.common.entity.CatEntity dogIn) {
