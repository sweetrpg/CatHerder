...
public class DogRespawnData implements IDogData {
    ...
    public void populate(kittytalents.common.entity.CatEntity dogIn) {
    ...
    @Nullable
    public kittytalents.common.entity.CatEntity respawn(ServerLevel worldIn, Player playerIn, BlockPos pos) {
        kittytalents.common.entity.CatEntity cat = KittyEntityTypes.CAT.get().spawn(worldIn, (CompoundTag) null, (Component) null, playerIn, pos, MobSpawnType.TRIGGERED, true, false);
